...
const Offerings: FC<{
  ...
  offeringsRes: { offerings, totalOfferings, count },
  churchServiceId,
}) => {
  return (
    <section>
      {count === 0 ? (
        <NoRecordFound
          message="Oops, No Offering Found"
          cta=" Add New Offering"
        ...
        <div className="shadow-md p-5">
          <div className="flex justify-between items-center">
            <h1 className="font-extrabold text-2xl mb-5 text-secondary">
              Total Offerings ({changeToHigherDenomination(totalOfferings)})
            </h1>
            <Link
              href={`/services/${churchServiceId}/offerings/new`}
